...
void overall() {
    ...
    // ID
    test_single_input("Control Unit", &controlUnit, "0000000100", extend("00001"));
    // EXE
    test_single_input("Left Shift 2", &left_shift_2, extend("100000"), extend("1000"));
    test_double_input("ALU Add", &alu_add, "00000000000000000000000000000010", "00000000000000000000000000000001", "00000000000000000000000000000001");
    test_double_input("ALU Sub", &alu_sub, "00000000000000000000000000000001", "00000000000000000000000000000010", "00000000000000000000000000000001");
